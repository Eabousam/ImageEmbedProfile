...
catalog_read <- getCatalog("provgigapath") |> 
    dplyr::filter(Project.ID == "TCGA-READ")

```

# Read Colon and Rectal Cancer assay with curatedTCGA

```{r load_rnaseq, message=FALSE}
#------------------------------------------
# Load COAD and READ RNASeq assay
#------------------------------------------
...
```{r linktcga}
coad_mae_emb <-
    imageFeatureTCGA::linkTCGA(coad_mae, catalog_coad, redownload = FALSE, parallel = FALSE)

read_mae_emb <-
    linkTCGA(coad_mae, catalog_read, redownload = FALSE, parallel = FALSE)
